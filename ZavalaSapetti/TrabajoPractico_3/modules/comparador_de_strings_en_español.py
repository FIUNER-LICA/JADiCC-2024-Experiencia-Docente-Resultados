import nltk # Natural Language Toolkit es una biblioteca para el procesamiento de lenguaje natural en Python.
from nltk.corpus import stopwords
from nltk.tokenize import word_tokenize #divide una cadena de texto en palabras individuales.
from nltk import FreqDist #calcula la frecuencia de aparición de palabras en un texto
from nltk.stem import SnowballStemmer #reduce las palabras a sus raíces
